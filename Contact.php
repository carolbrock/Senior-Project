...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h1> Having issues? Please fill out the form and we will get back to you. </h1>

	<form method="post">
  	<label for="search" style="text-align: center;"> Describe your issue here:</label>
  	<input type="text" id="search" name="search" style="height: 200px;">
 	 <input type="submit" style="text-align: center; width: 100%;">
	</form>
  </body>
